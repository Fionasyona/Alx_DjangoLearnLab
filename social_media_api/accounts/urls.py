...
urlpatterns = [
    ...
    path('followers/', FollowersListView.as_view(), name='list-followers'),  # List followers
    path('following/', FollowingListView.as_view(), name='list-following'),  # List following
]